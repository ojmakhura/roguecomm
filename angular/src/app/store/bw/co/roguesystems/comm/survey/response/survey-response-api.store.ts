...
import { SurveyResponseApi } from '@services/bw/co/roguesystems/comm/survey/response/survey-response-api';
      ...
      findById: rxMethod<{id: string | any }>(
        switchMap((data: any) => {
          ...
          return surveyResponseApi.findById(data.id, ).pipe(
            tapResponse({
              next: (data: SurveyResponseDTO | any) => {
                //patchState(
                  //store, 
                  // { 
                  //    data, 
      ...
      getAllPaged: rxMethod<{pageNumber: number | any , pageSize: number | any }>(
        switchMap((data: any) => {
          ...
          return surveyResponseApi.getAllPaged(data.pageNumber, data.pageSize, ).pipe(
            tapResponse({
              next: (data: Page<SurveyResponseDTO> | any) => {
                //patchState(
                  //store, 
                  // { 
                  //    data, 
